...
package ada_main is
   ...
   u00001 : constant Version_32 := 16#7b8e2a1c#;
   ...
   u00149 : constant Version_32 := 16#19385cde#;
   pragma Export (C, u00149, "resolutionsB");
   u00150 : constant Version_32 := 16#7d4b4efc#;
